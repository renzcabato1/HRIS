    ...
    <table width="100%" style='   font-size:12;'>
        ...
        <tr>
            <td style='text-align:left;'>
                Dear @if($inventory->accountabilities[0]->user_info->gender == 'MALE') Mr. @else Ms. / Mrs. @endif {{$inventory->accountabilities[0]->user_info->first_name." ".$inventory->accountabilities[0]->user_info->last_name}},
            </td>
        </tr>
        <tr>
            <td style='text-align:left;'>
