<div class="modal fade" id="proceed_applicant{{$applicant->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <form   method="POST" action='proceed-applicant/{{$applicant->id}}' onsubmit='show();'  >
                {{ csrf_field() }}
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <div class='row'>
                            <div class='col-lg-12'>
                                Position
                                <input class='form-control' value=''  name='position' type='text' required>
                            </div>
                        </div>
                        <div class='row'>
                            <div class='col-lg-12'>
